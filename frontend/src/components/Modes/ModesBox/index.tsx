    ...
    <>
      ...
      >
        <div className="h-full w-full">
          <img src={imageUrl} alt="" className="!h-[55vh] object-cover" />
        </div>
        ...
        <FlexColumn className="drop-shadow- absolute bottom-0 w-full items-center justify-center rounded-lg py-8">
          <p className="has-dropshadow orbitron-regular select-none text-base font-semibold text-white md:text-2xl">
            {modeTitle}
          </p>
