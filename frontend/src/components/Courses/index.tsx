            ...
            {courses?.map(course => {
              return (
                <motion.button
                  ...
                  key={course.id}
                  className="flex cursor-pointer flex-col gap-8 rounded-lg border bg-white px-6 py-8 shadow-box hover:shadow-lg disabled:cursor-not-allowed disabled:bg-gray-100 disabled:hover:shadow-box"
